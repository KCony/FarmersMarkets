...
class TestModel(unittest.TestCase):
    ...
    def test_find_by_city(self):
        ...
        true_list_name_market = [("26th Annual Highlands Business Partnership's Farmers Market", None, None),
                                 ("26th Annual Highlands Business Partnership's Farmers Market", None, None)]
